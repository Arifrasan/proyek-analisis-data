...
day_df = pd.read_csv("https://raw.githubusercontent.com/Arifrasan/proyek-analisis-data/main/Dashboard/day_data.csv")
hour_df = pd.read_csv("https://raw.githubusercontent.com/Arifrasan/proyek-analisis-data/main/Dashboard/hour_data.csv")
...
if selected_chart == 'Jumlah Pengguna Sepeda berdasarkan Hari':
    ...
    sns.barplot(
        ...
        y='count',
        hue='weekday',
        palette={"Friday": "#173f5f", "Monday": "#20639b", "Saturday": "#20639b", "Sunday": "#20639b", "Thursday": "#20639b", "Tuesday": "#20639b", "Wednesday": "#20639b"},
        ax=ax
    )
